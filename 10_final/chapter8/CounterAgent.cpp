...
CounterAgent::CounterAgent(uint8_t gp1, uint8_t gp2, uint8_t gp3, 
                           uint8_t gp4, uint8_t gp5, uint8_t gp6, uint8_t gp7) {
    pLedPads[0] = gp1;
    pLedPads[1] = gp2;
    pLedPads[2] = gp3;
    pLedPads[3] = gp4;
...
configSTACK_DEPTH_TYPE CounterAgent::getMaxStackSize(){
    return 256; // Augmenté légèrement pour la sécurité avec SMP
}
